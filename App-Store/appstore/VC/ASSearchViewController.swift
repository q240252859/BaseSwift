...
class ASSearchViewController: ASBaseViewController, searchTfDelegate, cancelBtnDelegate {
    ...
    private lazy var searchNav: ASNavSearchView = {
        ...
        let searchNav = ASNavSearchView(frame: CGRect(x: 0, y: Int(NAVIGATION_BAR_HEIGHT), width: Int(screenWidth), height: Int(NAVIGATION_BAR_HEIGHT)))
    ...
    private lazy var maskV: UIView = {
        ...
        let maskV = UIView(frame: CGRect(x: 0, y: Int(NAVIGATION_BAR_HEIGHT), width: Int(screenWidth), height: Int(screenHeight - CGFloat(NAVIGATION_BAR_HEIGHT))))
