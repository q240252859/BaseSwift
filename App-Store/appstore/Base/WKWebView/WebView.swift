...
//            request.setValue("userLanguage=\(LanguageHelper.getString(key: "select_languageKey"))", forHTTPHeaderField: "Cookie")
//            request.addValue("userLanguage=\(LanguageHelper.getString(key: "select_languageKey"))", forHTTPHeaderField: "Cookie")
        ...
        case .HTMLString(let StrHTML):
//            let str = "\(StrHTML)<style type=\"text/css\"> img{max-width: 100%%; height: auto;}</style>"
            
            loadStringHTMLHost(string: StrHTML)
    ...
    fileprivate func loadStringHTMLHost(string:String) {
